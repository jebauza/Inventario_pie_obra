...
<h2><font color="#178F99">Nuevo usuario</font></h2>
<table height="30"></table>
	...
	<form name="frm_usuario" id="form" method="post" action="controladora_usuario.php" onsubmit="return prueba()" >
		<table  width="770" height="189" border="0">
			...
			<tr>
			<td><input type="text" name="nombre" id="nomb" /></td>
			<td><input type="text" name="usuario" id="user" /></td>
			<td><input type="password" name="pass" id="contras" /></td>
			</tr>
			...
			<td></td>
			<td colspan="2">
					<input type="submit" name="insertarUser" value="Insertar usuario" /></td>
			</tr>
...
if(isset($_GET['var']))
{
  ...
  if($_GET['var']=='errorUserBD')
  {
         ?>
	     <script type="text/javascript" >
		 alert("Error al insertar el usuario en la Base Dato")
		 </script>
		 <?php
  } 
  if($_GET['var']=='adicionUser')
  {
         ?>
	     <script type="text/javascript" >
		 alert("Usuario adicionado en la base datos")
		 </script>
		 <?php
  }
}                                            
