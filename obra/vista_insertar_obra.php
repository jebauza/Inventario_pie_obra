...
<h2><font color="#178F99">Nueva obra</font></h2>
<table height="30"></table>

	<form name="frm_obra" id="form" method="post" action="controladora_obra.php" onsubmit="return insert_obra()" >
		<table  width="770" height="189" border="0">
			<caption align="bottom"></caption>

			<tr>
			<td width="200"><label for="co"><strong>*Codigo de obra</strong></label></td>

                <td height="21"><label for="txt_correo"><strong>Direccion de la obra</strong></label></td>
			<td width="200"><label for="teco"><strong>*Tecnico de la obra</strong></label></td>
			</tr>
			
			<tr>
			<td><input type="text" name="codObra" id="cod_obra" size="6" maxlength="6" /></td>

             <td><input type="text" name="direccion" id="direc" /></td>
			<td><input type="text" name="tecnico" id="tec" /></td>
			</tr>
			
			<tr height="30"></tr>
						
			<tr>
			<td height="21"><label for="txt_correo"><strong>*Ejecutor de la obra</strong></label></td>
			<td><label for="txt_correo"><strong>Fecha de inicio</strong></label></td>
			<td><label for="txt_correo"><strong>Fecha de entrega</strong></label></td>
			</tr>
			
			<tr>
			<td height="24"><input type="text" name="ejecutor" id="ejecut" /></td>
			<td><table><tr>
        ...
        <table width="770">
            <tr>
                <td><label for="desco"><strong>*Descriccion</strong></label></td>

            </tr>
            <tr>
                <td><textarea  id="texto" name="descriccion" id="descric" cols="50" rows="10"></textarea></td>
            </tr>
            <tr>
                <td></td>
                <td>
                    <input type="submit" name="insertarO" value="Insertar obra" /></td>
            </tr>
        </table>
	</form>
...
if(isset($_GET['var']))
{
  if($_GET['var']=='errorObraCod')
  {
         ?>
	     <script type="text/javascript" >
		 alert("Ya existe una obra con ese codigo de obra")
		 </script>
		 <?php
  }
  if($_GET['var']=='errorObraBD')
  {
         ?>
	     <script type="text/javascript" >
		 alert("Error al insertar la obra en la Base Dato")
		 </script>
		 <?php
  } 
  if($_GET['var']=='adicionObra')
  {
         ?>
	     <script type="text/javascript" >
		 alert("Obra adicionada en la base datos")
		 </script>
		 <?php
  }
}                                            
